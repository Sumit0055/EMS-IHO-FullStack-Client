    ...
    return (
        <form action="" onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <textarea
                            rows={3}
                            className=' resize-none' type="text"
                            name='bio'
            ...
            <div className="card p-5 sm:p-6">
                ...
                text-slate-900 mb-6 pb-4 border-b border-slate-100'>
                    Employee Details
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    <div className="">
                        <label className='block mb-2'>Department</label>
                        <select name='department' defaultValue={initialData?.deptName || ""}>
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    <div className='sm:col-span-2'>
                        ...
                        <input type="email" name='email' placeholder='Enter Your Work Email' required defaultValue={initialData?.email} />
                    </div>
                    {
                        !isEditMode && (
                            <div className=''>
