import { CalendarDays, FileText, X, Send , Loader2 } from 'lucide-react';
            ...
            <div
                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-6'>
                    ...
                    <div className="flex gap-3 pt-2">
                        <button type='button' disabled={loading} onClick={onClose} className='btn-secondary flex-1'>Cancle</button>
                        <button type='submit' onClick={onClose} className='btn-primary flex-1 flex items-center justify-center gap-2'>
                            {loading ? <Loader2 className='w-4 h-4 animate-spin' /> : <Send className='w-4 h-4' />} {loading ? "Submitting..." : ""}
                            </button>
                    </div>
                </form>
            </div>
